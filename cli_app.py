    ...
    data = [
        {
            ...
            "brand": "AromaVault",
            "price": 39.0,
            "notes": ["citrus", "bergamot", "fresh"],
        },
        {
            "name": "Midnight Oud",
            "brand": "AromaVault",
            "price": 79.0,
            "notes": ["oud", "smoke", "amber"],
        },
        {
            "name": "Vanilla Veil",
            "brand": "AromaVault",
            "price": 49.0,
            "notes": ["vanilla", "tonka", "warm"],
        },
    ]
    _save(data)
...
def list_perfumes() -> None:
    ...
    if not data:
        typer.echo(
            'No perfumes found. Try: aromavault add-perf "Name" --brand Brand --price 49.0 --notes rose,musk'
        )
